...
- Optional subtitle/quote — a small motivational line beneath the title in muted/gray text (use the quote: "You Got This!", or let me customize it).
...
### Files to generate:
1. manifest.json — Chrome extension manifest (Manifest V3), with chrome_url_overrides for newtab
2. newtab.html — The HTML page.
3. style.css — All styling.
4. script.js — Countdown logic, theme toggle, and localStorage persistence for theme preference.
5. icon.png (16×16, 48×48, 128×128) — Simple countdown/clock icon, or generate a minimal SVG-based one.
6. A README.md with installation instructions.
7. Package everything into a .zip file I can download directly.
